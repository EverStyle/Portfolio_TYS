            ...
            <div className='contact_img_block'>
                <div className="telegram-icon-container">
                    <CSSTransition
                        ...
                        unmountOnExit
                    >
                        <a href="https://t.me/YuraTab" target="_blank" rel="noopener noreferrer">
                            <svg
            ...
            <div className='contact_img_block'>
                <div className="github-icon-container">
                    <CSSTransition
                        ...
                        unmountOnExit
                    >
                        <a href="https://github.com/EverStyle" target="_blank" rel="noopener noreferrer">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="30"
                            height="30"
            ...
            <div className='contact_img_block'>
                <div className="vk-icon-container">
                    <CSSTransition
                        ...
                        unmountOnExit
                    >
                        <a href="https://vk.com/id346014309" target="_blank" rel="noopener noreferrer">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="30"
                            height="0.625em"
        ...
        <div className='contact_container'>
            <div className='imail_block'>
                <div className="rotating-email-link-container">
                    <a
                        href="mailto:evilknife2013@yandex.ru"
                        className="rotating-email-link"
                    >
                        evilknife2013@yandex.ru
                    </a>
                </div>
            </div>
